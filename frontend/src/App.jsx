...
import { Upload, Video, Play, Pause, Loader2, Heart, Brain, Music, BookOpen, Youtube } from 'lucide-react'
      ...
      <div className="container mx-auto px-4 py-8">
        <header className="text-center mb-12">
          ...
          <p className="text-xl text-violet-200 max-w-2xl mx-auto">
            Discover your emotions through AI-powered analysis of facial expressions and voice patterns
          </p>
        </header>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="card">
            ...
            <p className="text-sm text-violet-300 mt-4">
              Upload a video file for emotion analysis. Results may vary based on camera clarity, lighting, facial expressions, and audio surroundings.
            </p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="card">
              ...
              <div className="grid md:grid-cols-3 gap-4 mb-6">
                <div className="text-center">
                  <div className="text-3xl font-bold text-violet-400">{results.audio_emotion}</div>
                  <div className="text-sm text-violet-300">Audio Emotion</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-violet-400">{results.video_emotion}</div>
                  <div className="text-sm text-violet-300">Video Emotion</div>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold text-purple-400">{results.fused_emotion}</div>
            ...
            <div className="card">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="text-lg font-semibold mb-4">Audio Emotions Over Time</h4>
                  <Line
                    data={createChartData(results.audio_probs_temporal, 'Audio')}
                    options={chartOptions}
                  />
                </div>
                <div>
                  <h4 className="text-lg font-semibold mb-4">Video Emotions Over Time</h4>
                  <Line
                    data={createChartData(results.video_probs_temporal, 'Video')}
                    options={chartOptions}
                  />
                </div>
              </div>
            ...
            <div className="card">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  <h4 className="text-lg font-semibold mb-2">Inspirational Quote</h4>
        ...
        <footer className="text-center mt-16 py-8 border-t border-violet-500/30">
          <p className="text-violet-300">
            Powered by advanced machine learning to understand human emotions through multimodal analysis
          </p>
        </footer>
      </div>
    </div>
